...
CREATE TABLE "catogorys" (
    ...
    CONSTRAINT "catogorys_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "products" ADD CONSTRAINT "products_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "catogorys"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
